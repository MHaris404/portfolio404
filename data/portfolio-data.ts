...
export const projects = [
  ...
  // ADD YOUR PROJECTS FROM GITHUB HERE
  // The component will also automatically fetch from:
  // https://raw.githubusercontent.com/MHaris404/portfolio/main/projects/projects.json
  //
  // JSON Format in projects.json should be:
  // [
  //   {
  //     "title": "Project Name",
  //     "description": "Detailed project description",
  //     "image": "/projects/image.png",  // or full URL
  //     "media": "/projects/demo.mp4",   // optional: video or gif
  ...
  //     "category": "web"  // optional: for filtering (web, mobile, backend, ai, etc.)
  //   }
  // ]
  //
  // EXAMPLE PROJECTS (Uncomment and customize):
  // {
  //   title: "E-Commerce Mobile App",
  //   description: "Full-featured React Native e-commerce application with payment integration, real-time inventory management, and user authentication.",
  //   image: "/projects/ecommerce.png",
  //   media: "/projects/ecommerce-demo.mp4", // Video demo
